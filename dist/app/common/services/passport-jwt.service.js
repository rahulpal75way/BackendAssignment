...
const initPassport = () => {
    ...
    passport_1.default.use("login", new passport_local_1.Strategy({
        ...
        try {
            ...
            const { password: _p } = user, rest = __rest(user, ["password"]);
            const result = Object.assign(Object.assign({}, rest), { provider: (_a = user.provider) !== null && _a !== void 0 ? _a : undefined });
...
const createUserTokens = (user) => {
    ...
    const accessToken = jsonwebtoken_1.default.sign(payload, jwtSecret, {
        expiresIn: (_a = process.env.ACCESS_TOKEN_EXPIRY) !== null && _a !== void 0 ? _a : "20s",
    });
    const refreshToken = jsonwebtoken_1.default.sign(payload, refreshTokenSecret, {
        expiresIn: (_b = process.env.REFRESH_TOKEN_EXPIRY) !== null && _b !== void 0 ? _b : "5m",
    });
